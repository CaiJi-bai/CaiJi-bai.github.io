...
<table border="1">
    ...
    <tr>
        <td>来源</td>
        <td>23rd AISTATS 2020: Online [Palermo, Sicily, Italy] [CCF 人工智能 C 类会议]</td>
    </tr>
    <tr>
        <td>年份</td>
        <td>2020 年 8 月</td>
...
1. 联邦学习明确假设参与者的本地训练数据集相对较小并且来自不同的分布。因此，局部模型倾向于过度拟合，偏离联合全局模型，并且精度低。
